...
const BELL_OPERATORS: [OperatorTuple; 6] = [
    (1.0, 0.78, 0.003, 0.18, 1.8, 2.4, 1.0, 0.62, 0.18, 0.25, 0.0),
    (
        1.414, 0.68, 0.002, 0.09, 0.55, 1.1, 1.0, 0.48, 0.05, 0.55, 0.0,
    ),
    (1.0, 0.58, 0.002, 0.24, 2.4, 2.8, 1.0, 0.70, 0.22, 0.18, 0.0),
    (
...
const MALLET_OPERATORS: [OperatorTuple; 6] = [
    (1.0, 0.72, 0.004, 0.16, 1.1, 1.5, 1.0, 0.72, 0.28, 0.45, 0.0),
    (
        1.0, 0.52, 0.001, 0.055, 0.34, 0.65, 1.0, 0.32, 0.01, 0.75, 0.0,
    ),
    (
        1.0, 0.42, 0.003, 0.20, 1.25, 1.6, 1.0, 0.68, 0.24, 0.35, -2.0,
    ),
    (
        14.0, 0.22, 0.001, 0.025, 0.16, 0.35, 1.0, 0.16, 0.0, 0.85, 0.0,
    ),
    (
        2.0, 0.28, 0.002, 0.12, 0.80, 1.1, 1.0, 0.48, 0.12, 0.30, 2.0,
    ),
...
const BRASS_OPERATORS: [OperatorTuple; 6] = [
    (
        1.0, 0.76, 0.012, 0.13, 0.50, 0.24, 1.0, 0.84, 0.70, 0.20, 0.0,
    ),
    (
        1.0, 0.56, 0.010, 0.10, 0.34, 0.20, 1.0, 0.72, 0.52, 0.35, 0.0,
    ),
    (
        1.0, 0.34, 0.008, 0.08, 0.28, 0.18, 1.0, 0.64, 0.44, 0.30, 0.0,
    ),
    (
        2.0, 0.48, 0.006, 0.09, 0.30, 0.20, 1.0, 0.65, 0.42, 0.30, 0.0,
    ),
    (
...
const MECHANICAL_OPERATORS: [OperatorTuple; 6] = [
    (
        0.5, 0.72, 0.002, 0.055, 0.22, 0.16, 1.0, 0.54, 0.08, 0.25, 0.0,
    ),
    (
...
impl ListeningPatch {
    ...
    pub const fn pair_gain(self) -> f32 {
        match self {
            Self::BellMetal | Self::FracturedMetal => 0.72,
            Self::ElectricPianoMallet | Self::GlassWood => 0.68,
            Self::BrassBass | Self::MechanicalStab => 0.74,
        }
    }
