...
- [x] **Step 1: Write failing oscillator contract tests**
...
- [x] **Step 3: Implement the two minimal scalar candidates**
...
- [x] **Step 4: Run focused and library tests and verify GREEN**
...
- [x] **Step 3: Implement deterministic offline analysis and lab output**
...
- [x] **Step 4: Verify the analysis tests and run the comparison**
...
- [x] **Step 5: Select the winner from recorded evidence**
...
- [x] **Step 1: Write failing macro-route tests**
...
- [x] **Step 3: Implement minimal macro routing**
...
- [x] **Step 4: Verify GREEN and allocation behavior**
...
- [x] **Step 1: Write failing lab/render CLI tests**
...
- [x] **Step 3: Implement and generate the listening matrix**
...
- [x] **Step 2: Run lint and native release build**

Run: `cargo clippy --all-targets --all-features -- -D warnings`

Run: `cargo build --release`

- [x] **Step 3: Run dependency policy checks**

Run: `cargo audit`

Run: `cargo deny check`

- [x] **Step 4: Run AArch64 compile evidence**
